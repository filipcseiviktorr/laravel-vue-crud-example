<template>
    <Dialog :header="isEditingModel ? 'Edit Model' : 'Add Model'" v-model:visible="localShowModelDialog"
        ...
        <div class="p-fluid space-y-6">
            <div class="field">
                ...
                <InputText id="modelName" v-model="localModelName" placeholder="Max 40 characters"
            ...
            <div class="pt-5">
                ...
                <FilePond
                    ...
                    ref="pond"
                    class=""
                    :files="selectedModel?.path ? [{ source: selectedModel.path, options: { type: 'remote' } }] : []"
...
const emit = defineEmits(['update:showModelDialog', 'update:isEditingModel', 'update:modelName', 'update:errors', 'addModel', 'editModel', 'onFileChange']);
...
watch(() => props.showModelDialog, (newVal) => {
...
watch(() => props.isEditingModel, (newVal) => {
