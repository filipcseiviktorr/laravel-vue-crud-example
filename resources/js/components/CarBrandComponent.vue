        ...
        <div class="w-full">
            ...
            >
                ...
                <template v-slot:headers v-if="paginatedCarList.length">
                    <th class="bg-blue-600 text-white px-6 py-3 rounded-tl-lg"><span>Model Name</span></th>
                ...
                <template v-slot:body>
                    <tr v-for="(car, index) in paginatedCarList" :key="car.id"
                        ...
                        <td class="px-6 py-3 text-center w-1/3  text-lg">{{ car.model }}</td>
                        ...
                        <td class="px-6 py-3 text-center w-1/3">
                            <div class="flex flex-col justify-center items-center md:flex-row md:space-x-2">
                                <Button icon="pi pi-pencil" @click="editCar(car)" class="rounded-full bg-blue-500 shadow-lg text-white p-2  mr-0 md:mr-2"/>
                                <Button icon="pi pi-trash" @click="deleteCar(car)" class="rounded-full bg-red-500 shadow-lg text-white p-2"/>
                            </div>
                        </td>
                    </tr>
                </template>
